...
//Esta entrega es igual a entregas anteriores, ya que para ese momento
//habiamos aplicado lo que se califica en la entrega actual, el cambio mas relevante es una organización
//de los cout y se solucionó un error en el case 2 con numeros negativos
...
int main() 
    ...
    do 
        ...
        cout << "\nElija la opción que requiera \n"
             ...
             << "(8) Consultar valor por producto de donacion a FOPRE \n"
             << "(9) Consultar valor total de donacion a FOPRE \n"
             << "(10) Salir \n"
             << "Solo son validos números enteros\n";
        cin >> opcion;

        switch (opcion) 
            {
            case 1:
            cout << "\nProductos Disponibles:"<<"         Precio          "<<"Cantidad\n";
            ...
            break;
            case 2:
            cout << "\nSu crédito actual es: " << credito.valor << endl;
            ...
            case 3:
                ...
                {
                cout <<"\nCrédito insuficiente para la compra minima, por favor agregue más.\n";
                } else 
                    {
                    cout <<"Seleccione el producto:         Credito disponible: "<<credito.valor<<endl
